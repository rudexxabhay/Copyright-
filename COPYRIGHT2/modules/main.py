...
async def start(_, msg):
    ...
    await msg.reply_photo(
        photo="https://telegra.ph/file/a9eee62e154bdb51a2fd2.jpg",
        caption=start_txt,
...
gd_buttons = [              
        [
            ...
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/CrownnNetworks"),    
        ]
        ]
